      ...
      <section className="noise-bg relative overflow-hidden border-b border-border">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:py-28">
          ...
          <div className="mt-16 grid gap-6 border-t border-border pt-8 text-sm sm:grid-cols-3">
            <Stat emoji="📍" label="where we at" value="30 Hassan Assem St" sub="Zamalek, Cairo" />
            <Stat emoji="🕐" label="hours" value="3PM – 11PM" sub="every single day" />
            <Stat emoji="🤌" label="the vibe" value="Streetwear × Thrift" sub="pizza steve energy" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        <div className="flex items-end justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">these won't last long fr</p>
          </div>
