...
interface Product { id: string; name: string; size?: string; price?: number; priceLabel?: string; status: string; emoji?: string; tag?: string; imageUrl?: string; }
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <a href={IG} target="_blank" rel="noreferrer" className="border border-zinc-600 hover:border-orange-500 text-zinc-300 hover:text-orange-400 font-bold px-8 py-4 rounded-full tracking-widest transition-colors text-sm">
              INSTAGRAM
            </a>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          {subMsg ? (
            ...
            <div className="flex gap-2">
              ...
              <button onClick={subscribe} className="bg-black text-white font-black px-6 py-3 rounded-full text-sm hover:bg-zinc-800 transition-colors">
                IN
              </button>
            </div>
          )}
